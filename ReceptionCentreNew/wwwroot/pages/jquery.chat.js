...
!function($) {
    ...
    ChatApp.prototype.save = function() {
        ...
        if (chatText == "") {
            ...
            $('<li class="clearfix"><div class="chat-avatar"><img src="~/img/avatar-1.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>John Deo</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
            this.$chatInput.val('');
            this.$chatInput.focus();
