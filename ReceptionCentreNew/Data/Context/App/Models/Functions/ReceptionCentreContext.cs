...
public partial class ReceptionCentreContext : DbContext
{
    ...
    {
        return this.Database.SqlQueryRaw<ChartInWeek>("SELECT * FROM chart_in_week()").ToArray();
    }
    public virtual IEnumerable<ChartInYear> FuncChartInYear()
    {
        return this.Database.SqlQueryRaw<ChartInYear>("SELECT * FROM chart_in_year()").ToArray();
    }
    public virtual IEnumerable<ChartClaimInWeek> FuncChartClaimInWeek()
    {
        return this.Database.SqlQueryRaw<ChartClaimInWeek>("SELECT * FROM chart_claim_in_week()").ToArray();
    }
    public virtual IEnumerable<ChartClaimInYear> FuncChartClaimInYear()
    {
        return this.Database.SqlQueryRaw<ChartClaimInYear>("SELECT * FROM chart_claim_in_year()").ToArray();
    }

    public virtual IEnumerable<ChartClaimForMfc> FuncChartClaimForMfc()
    {
        return this.Database.SqlQueryRaw<ChartClaimForMfc>("SELECT * FROM chart_claim_for_mfc()").ToArray();
    }
    ...
    public virtual IEnumerable<StatisticsDataAppeal> FuncStatisticsDataAppeal(Guid? SprMfcId, Guid? spr_treatment_id, Guid? SprCategoryId, Guid? SprTypeId, Guid? SprTypeDifficultyId)
    {
        ...
        return this.Database.SqlQueryRaw<StatisticsDataAppeal>("SELECT * FROM statistics_data_appeal(@in_spr_mfc_id, @in_spr_subject_treatment_id,@in_spr_category_id, @in_spr_type_id, @in_SprTypeDifficulty_id)", param1, param2, param3, param4, param5).ToArray();
    }
    ...
    {
        return this.Database.SqlQueryRaw<StatisticsDataAppealCall>("SELECT * FROM statistics_data_appeal_call()").ToArray();
    }
